...
from app.menus.package import get_package_details, show_package_details
...
def show_bookmark_menu(return_package_detail: bool = False):
    ...
    while True:
        ...
        choice = console.input(
            f"[{theme['text_title']}]Pilih bookmark (nomor):[/{theme['text_title']}] "
        ).strip()
        ...
        if choice == "00":
            ...
            del_choice = console.input(
                "Masukkan nomor bookmark yang ingin dihapus: "
            ).strip()
