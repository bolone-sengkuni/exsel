...
from app.menus.util import clear_screen, get_rupiah, pause, print_panel

console = Console()


def fetch_special_for_you(
    ...
    while True:
        ...
        if 0 <= choice_idx < len(special_packages):
            ...
            result = show_package_details(
                api_key, tokens, selected_pkg["kode_paket"], is_enterprise=False
            )
